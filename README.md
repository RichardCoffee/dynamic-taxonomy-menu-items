...
Simply activating the plugin will, by default, add a category sub-menu to your primary menu.  The setup screen can be reached either via the settings link on the Installed Plugins page, or via the new 'Dynamic Taxonomy' option on the Appearence menu.
