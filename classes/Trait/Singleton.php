...
trait DynTaxMI_Trait_Singleton {
	...
	private function __clone() {
		$message = __( 'This class can not be cloned.' , 'dyntaxmi' ) . ' * ' . debug_calling_function();
	...
	public function __sleep() {
		$message = __( 'This class can not be serialized.' , 'dyntaxmi' ) . ' * ' . debug_calling_function();
		$version = ( property_exists( $this, 'version' ) ) ? $this->version : '0.0.0';
		_doing_it_wrong( __FUNCTION__, esc_html( $message ), esc_html( $version ) );
	}
	...
	private function __wakeup() {
		$message = __( 'This class can not be unserialized.' , 'dyntaxmi' ) . ' * ' . debug_calling_function();
		$version = ( property_exists( $this, 'version' ) ) ? $this->version : '0.0.0';
		_doing_it_wrong( __FUNCTION__, esc_html( $message ), esc_html( $version ) );
	}
